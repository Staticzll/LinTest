...
android {
    namespace = "com.tianjuan.navigation"
    compileSdk = v("compileSdk") as Int

    defaultConfig {
        applicationId = "com.tianjuan.navigation"
        minSdk = v("minSdk") as Int
        targetSdk = v("targetSdk") as Int
        versionCode = 1
        versionName = "1.0"
