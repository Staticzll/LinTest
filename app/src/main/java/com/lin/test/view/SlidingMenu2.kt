 ...
 */
class SlidingMenu2(context: Context, attr: AttributeSet?, defStyleAttr: Int) :
    ...
    override fun onFinishInflate() {
        ...
        mContentView?.let {
            ...
            mShadowView = View(context).apply {
    ...
    override fun onScrollChanged(l: Int, t: Int, oldl: Int, oldt: Int) {
        ...
        // 控制阴影 0-1
        val alphaScale = 1 - scale
        mShadowView?.alpha = alphaScale
...
//            ViewCompat.setScaleY(it, leftScale)
            // 抽屉，平移
            ViewCompat.setTranslationX(it, 0.7f * l)
        }
    }
